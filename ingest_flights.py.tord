...
def compute_current_month():
    currentDate = datetime.datetime.now()
    return '{}'.format(currentDate.year), '{:02d}'.format(currentDate.month)
...
if __name__ == '__main__':
   ...
   try:
      ...
      yearNow, monthNow = compute_current_month()
      while year+month < yearNow+monthNow:
